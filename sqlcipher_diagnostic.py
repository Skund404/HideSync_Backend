...
def direct_sqlite_write_test():
    """
    Perform a direct SQLite write test using pysqlcipher3
    to bypass SQLAlchemy abstraction
    """
    try:
...
def sqlalchemy_direct_write_test():
    """
    Perform a direct SQLAlchemy write test with SQLCipher configuration
    Bypassing standard SQLAlchemy connection handling
    """
    try:
        import pysqlcipher3.dbapi2 as sqlcipher
