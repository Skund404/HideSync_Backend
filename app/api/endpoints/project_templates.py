...
api_router.include_router(
    recurring_projects.router, prefix="/recurring-projects", tags=["recurring-projects"]
)
api_router.include_router(roles.router, prefix="/roles", tags=["roles"])
api_router.include_router(
    platform_integrations.router,
    prefix="/platform-integrations",
    tags=["platform-integrations"],
)
api_router.include_router(
    picking_list.router, prefix="/picking-lists", tags=["picking-lists"]
)
