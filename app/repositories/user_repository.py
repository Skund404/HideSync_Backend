    ...
    def get_by_email(self, email: str):
        ...
        try:
            ...
            approaches = [
                ...
                {
                    "name": "Standard SQLCipher 4",
                    "params": [f"PRAGMA key='{key}';", "PRAGMA foreign_keys=ON;"],
                },
                # Approach 2: SQLCipher 3 compatibility
                {
                    "name": "SQLCipher 3 compatibility",
                    "params": [
                        f"PRAGMA key='{key}';",
                ...
                {
                    "name": "Legacy mode with kdf_iter=64000",
                    "params": [
                        f"PRAGMA key='{key}';",
                        "PRAGMA cipher_compatibility=3;",
                ...
                {
                    "name": "Hex key format",
                    "params": [f"PRAGMA key=\"x'{key}'\";", "PRAGMA foreign_keys=ON;"],
                },
                # Approach 5: From your setup_db.py script
                {
                    "name": "Setup script params",
                    "params": [
                        f"PRAGMA key='{key}';",
