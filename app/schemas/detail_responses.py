...
class CustomerWithSales(CustomerResponse):
    ...
    first_purchase_date: Optional[datetime] = Field(
        None, description="Date of first purchase"
    )
    last_purchase_date: Optional[datetime] = Field(
        None, description="Date of most recent purchase"
    )
...
class MaterialWithInventory(MaterialResponse):
    ...
    inventory: List[InventoryResponse] = Field(
        [], description="Inventory records for this material"
    )
    total_quantity: float = Field(
        ..., description="Total quantity across all inventory records"
    )
    total_value: float = Field(..., description="Total inventory value")
    storage_locations: List[str] = Field(
        [], description="Storage locations containing this material"
    )
    purchase_history_summary: Optional[Dict[str, Any]] = Field(
        None, description="Summary of purchase history"
    )
    usage_history_summary: Optional[Dict[str, Any]] = Field(
        None, description="Summary of usage history"
    )
...
class ProjectWithDetails(ProjectResponse):
    ...
    components: List[ProjectComponentResponse] = Field(
        [], description="Components used in this project"
    )
    timeline_tasks: List[TimelineTaskResponse] = Field(
        [], description="Timeline tasks for this project"
    )
    materials_summary: Optional[Dict[str, Any]] = Field(
        None, description="Summary of materials used"
    )
    customer_details: Optional[Dict[str, Any]] = Field(
        None, description="Customer details if associated"
    )
    related_sales: List[SaleResponse] = Field(
        [], description="Sales related to this project"
    )
    resource_allocation: Optional[Dict[str, Any]] = Field(
        None, description="Allocated resources"
    )
...
class SaleWithDetails(SaleResponse):
    ...
    related_projects: List[ProjectResponse] = Field(
        [], description="Projects related to this sale"
    )
    ...
    shipping_details: Optional[Dict[str, Any]] = Field(
        None, description="Shipping details"
    )
    profit_analysis: Optional[Dict[str, Any]] = Field(
        None, description="Profit analysis"
    )
...
class SupplierWithDetails(SupplierResponse):
    ...
    materials: List[MaterialResponse] = Field(
        [], description="Materials supplied by this supplier"
    )
    ratings: List[Dict[str, Any]] = Field([], description="Ratings for this supplier")
    purchase_history: List[Dict[str, Any]] = Field(
        [], description="Purchase history summary"
    )
    performance_metrics: Optional[Dict[str, Any]] = Field(
        None, description="Supplier performance metrics"
    )
    contact_history: Optional[List[Dict[str, Any]]] = Field(
        None, description="Contact history"
    )
...
class InventoryWithHistory(InventoryResponse):
    ...
    stock_level_trend: Optional[List[Dict[str, Any]]] = Field(
        None, description="Stock level trend"
    )
    usage_pattern: Optional[Dict[str, Any]] = Field(
        None, description="Usage pattern analysis"
    )
