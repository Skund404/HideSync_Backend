...
class EntityMediaBase(BaseModel):
    ...
    entity_type: str = Field(..., description="Type of entity (material, tool, supplier, etc.)")
    entity_id: str = Field(..., description="ID of the entity")
    media_asset_id: str = Field(..., description="ID of the media asset")
    media_type: str = Field("thumbnail", description="Type of media (thumbnail, gallery, etc.)")
...
class EntityMediaUpdate(BaseModel):
    ...
    media_type: Optional[str] = Field(None, description="Type of media (thumbnail, gallery, etc.)")
    display_order: Optional[int] = Field(None, description="Display order for the media")
    caption: Optional[str] = Field(None, description="Optional caption or description")
...
class EntityMediaResponse(EntityMediaInDB):
    ...
    media_asset: Optional[MediaAssetResponse] = Field(None, description="The associated media asset")
