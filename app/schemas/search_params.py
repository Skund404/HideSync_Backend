...
class InventorySearchParams(BaseModel):
    ...
    below_reorder_point: Optional[bool] = Field(
        None, description="Filter items below reorder point"
    )
    supplier_id: Optional[int] = Field(None, description="Filter by supplier ID")
...
class SupplierSearchParams(BaseModel):
    ...
    min_rating: Optional[int] = Field(
        None, description="Minimum supplier rating", ge=1, le=5
    )
    max_rating: Optional[int] = Field(
        None, description="Maximum supplier rating", ge=1, le=5
    )
...
class StorageSearchParams(BaseModel):
    ...
    occupancy_rate_min: Optional[float] = Field(
        None, description="Minimum occupancy rate (0-100)"
    )
    occupancy_rate_max: Optional[float] = Field(
        None, description="Maximum occupancy rate (0-100)"
    )
