...
class MediaAssetCreate(MediaAssetBase):
    ...
    tag_ids: Optional[List[str]] = Field(
        default=None, description="List of tag IDs to assign"
    )
...
class MediaAssetResponse(MediaAssetBase):
    ...
    tags: Optional[List[TagResponse]] = Field(
        None, description="Tags assigned to this asset"
    )
...
class MediaAssetWithTags(MediaAssetResponse):
    ...
    tags: List[TagResponse] = Field(
        default_factory=list, description="Tags assigned to this asset"
    )
...
class MediaAssetSearchParams(BaseModel):
    ...
    uploaded_after: Optional[datetime] = Field(
        None, description="Filter by upload date (after)"
    )
    uploaded_before: Optional[datetime] = Field(
        None, description="Filter by upload date (before)"
    )
