...
class RefundCreate(RefundBase):
    ...
    payment_method: Optional[str] = Field(None, description="Method used for the refund")
...
class RefundProcess(BaseModel):
    ...
    notes: Optional[str] = Field(None, description="Additional notes about the refund processing")
...
class RefundInDB(RefundBase):
    ...
    transaction_id: Optional[str] = Field(None, description="External transaction ID")
    payment_method: Optional[str] = Field(None, description="Method used for the refund")
    processed_by: Optional[int] = Field(None, description="ID of the user who processed the refund")
    created_at: datetime = Field(..., description="Timestamp when the refund was created")
    updated_at: datetime = Field(..., description="Timestamp when the refund was last updated")
...
class RefundResponse(RefundInDB):
    ...
    sale: Optional[Dict[str, Any]] = Field(None, description="Summary of the refunded sale")
    processor_name: Optional[str] = Field(None, description="Name of the user who processed the refund")
    days_since_created: Optional[int] = Field(None, description="Days elapsed since the refund was created")
